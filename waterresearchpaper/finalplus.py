...
# ===============================
# 13A. Evaluation — ALL REGIMES
# ===============================
print("\n================ XGBOOST RESULTS (ALL REGIMES) ================")
print("Test R²  :", round(r2_score(y_test, y_pred), 4))
print("Test RMSE:", round(mean_squared_error(y_test, y_pred, squared=False), 4))


# ===============================
# 13B. Evaluation — EXCLUDING Neutral_LowC0
# ===============================
mask = r_test != "Neutral_LowC0"

y_test_reduced = y_test[mask]
y_pred_reduced = y_pred[mask]

print("\n====== XGBOOST RESULTS (EXCLUDING Neutral_LowC0) ======")
print("Test R²  :", round(r2_score(y_test_reduced, y_pred_reduced), 4))
print("Test RMSE:", round(mean_squared_error(y_test_reduced, y_pred_reduced, squared=False), 4))


# ===============================
# 13C. Regime-wise Performance
# ===============================
print("\nRegime-wise Performance (Test Set):")
rows = []
for r in r_test.unique():
    ...
    rows.append({
        "Regime": r,
        "Samples": idx.sum(),
        "R²": r2_score(y_test[idx], y_pred[idx]) if idx.sum() >= 10 else "N/A",
