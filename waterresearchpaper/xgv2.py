# ==========================================================
# PHYSICS-PROXY ABLATION STUDY
# One proxy at a time (Zeta, CEC, FTIR)
# ==========================================================
...
# ==========================================================
# 6. SINGLE-PROXY DEFINITIONS
# ==========================================================
df["Zeta_proxy"] = (df["Initial pH"] - 7)
df["CEC_proxy"] = (df["Adsorption capacity(mg/g)"] * df["Dose(g/L)"]) / (df["Surface area(m2/g)"] + 1e-6)
df["FTIR_proxy"] = df["Adsorption capacity(mg/g)"] / (df["Surface area(m2/g)"] + 1e-6)
...
# ==========================================================
# 8. FEATURE SETS (CONTROLLED ABLATION)
# ==========================================================
BASE = [
...
FEATURE_SETS = {
    ...
    "M2_Physics": PHYSICS,
    "M3_Ionic": IONIC,
    "M4_Zeta": IONIC + ["Zeta_proxy"],
    "M5_CEC": IONIC + ["CEC_proxy"],
    "M6_FTIR": IONIC + ["FTIR_proxy"]
}
...
for name, feats in FEATURE_SETS.items():
    ...
    results.append({
        ...
        "Restricted_R2": r2_score(y_te[mask], y_pred[mask]),
